...
namespace FSH.Infrastructure.Persistence.Tests;
...
public class ConnectionStringSecurerTests
{
    ...
    public void MakeSecureTest(string connectionString, string dbProvider, bool containsCredentials, string name)
    {
        ...
        Assert.True(check1?.Equals(res1, StringComparison.InvariantCultureIgnoreCase),
            name); // don't know what this is actually testing?
