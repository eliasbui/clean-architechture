...
namespace FSH.Application.Common.Specification;
...
public static class SpecificationBuilderExtensions
{
        ...
        Filter? filter)
    {
        if (filter is not null)
        {
            ...
            else
            {
                ...
                binaryExpresioFilter = CreateFilterExpression(filterValid.Field!, filterValid.Operator!,
        ...
        ParameterExpression parameter)
    {
        ...
        foreach (var filter in filters)
        {
            ...
            {
                var filterValid = GetValidFilter(filter);
                bExpresionFilter = CreateFilterExpression(filterValid.Field!, filterValid.Operator!, filterValid.Value,
                    parameter);
            }
