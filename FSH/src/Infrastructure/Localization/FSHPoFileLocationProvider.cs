using FSH.Infrastructure.Common.Extensions;
...
namespace FSH.Infrastructure.Localization;
...
public class FSHPoFileLocationProvider : ILocalizationFileLocationProvider
{
    ...
    public FSHPoFileLocationProvider(IHostEnvironment hostingEnvironment,
